...
const Header = () => {
  ...
  return (
    <>
      <header
        id="header"
        className="flex justify-between items-center mt-7 mb-5 mx-5 sm:mx-10"
      >
        <Link href="/">
          <a>
            <Images img="/images/zonoworks2.jpg" height={50} width={230} />
          </a>
        </Link>
        ...
        <div className="md:hidden cursor-pointer" onClick={() => toggleMenu()}>
          <MdMenu
            className={openMenu ? NavigationStyles.open : undefined}
            size="2em"
          />
        </div>
      </header>
      <div
        className={`${NavigationStyles.drawerMenu} ${
          openMenu ? NavigationStyles.open : undefined
        }`}
      >
        <ul>
